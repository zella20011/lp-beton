$(document).ready(function () {
	...
	/*var navPos, winPos, navRes //navHeight;
  
	function refreshVar() {
	  navPos = $('.price').offset().top;
	  navRes = $('.order').offset().top;
	  //navHeight = $('.price').outerHeight(true);
	}
	...
	$(window).scroll(function() {
	  ...
	  if (winPos >= navPos) {
	  	$('header nav ul .two').addClass('active');
	    //$('nav').addClass('fixed shadow');  
	    //$('.clone-nav').show();
	  }
	  if (winPos >= navRes) {
	  	$('header nav ul .thre').addClass('active');
	  } 
	  else {
